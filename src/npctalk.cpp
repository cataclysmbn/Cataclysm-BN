                          ...
                          const talk_topic &topic )
{
    ...
    if( challenge[0] == '&' ) {
        ...
        challenge = string_format( pgettext( "npc does something", "%s %s" ), colorize( beta->name, c_light_green ),
                                   challenge.substr( 1 ) );
    } else {
        challenge = string_format( pgettext( "npc says something", "%s: %s" ), colorize( beta->name, c_light_green ),
                                   challenge );
    }
    ...
    std::string response_printed = string_format( pgettext( "you say something", "%s: %s" ), colorize( _( "You"), c_green),
