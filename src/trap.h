...
bool none( const tripoint_abs_ms &, Creature *, item * );
bool bubble( const tripoint_abs_ms &p, Creature *c, item *i );
bool glass( const tripoint_abs_ms &p, Creature *c, item *i );
bool cot( const tripoint_abs_ms &p, Creature *c, item *i );
bool beartrap( const tripoint_abs_ms &p, Creature *c, item *i );
bool snare_light( const tripoint_abs_ms &p, Creature *c, item *i );
bool snare_heavy( const tripoint_abs_ms &p, Creature *c, item *i );
bool board( const tripoint_abs_ms &p, Creature *c, item *i );
bool caltrops( const tripoint_abs_ms &p, Creature *c, item *i );
bool caltrops_glass( const tripoint_abs_ms &p, Creature *c, item *i );
bool tripwire( const tripoint_abs_ms &p, Creature *c, item *i );
bool crossbow( const tripoint_abs_ms &p, Creature *c, item *i );
bool shotgun( const tripoint_abs_ms &p, Creature *c, item *i );
bool blade( const tripoint_abs_ms &p, Creature *c, item *i );
bool landmine( const tripoint_abs_ms &p, Creature *c, item *i );
bool telepad( const tripoint_abs_ms &p, Creature *c, item *i );
bool goo( const tripoint_abs_ms &p, Creature *c, item *i );
bool dissector( const tripoint_abs_ms &p, Creature *c, item *i );
bool sinkhole( const tripoint_abs_ms &p, Creature *c, item *i );
bool pit( const tripoint_abs_ms &p, Creature *c, item *i );
bool pit_spikes( const tripoint_abs_ms &p, Creature *c, item *i );
bool pit_glass( const tripoint_abs_ms &p, Creature *c, item *i );
bool lava( const tripoint_abs_ms &p, Creature *c, item *i );
bool portal( const tripoint_abs_ms &p, Creature *c, item *i );
bool ledge( const tripoint_abs_ms &p, Creature *c, item *i );
bool boobytrap( const tripoint_abs_ms &p, Creature *c, item *i );
bool temple_flood( const tripoint_abs_ms &p, Creature *c, item *i );
bool temple_toggle( const tripoint_abs_ms &p, Creature *c, item *i );
bool glow( const tripoint_abs_ms &p, Creature *c, item *i );
bool hum( const tripoint_abs_ms &p, Creature *c, item *i );
bool shadow( const tripoint_abs_ms &p, Creature *c, item *i );
bool map_regen( const tripoint_abs_ms &p, Creature *c, item *i );
bool drain( const tripoint_abs_ms &p, Creature *c, item *i );
bool snake( const tripoint_abs_ms &p, Creature *c, item *i );
bool cast_spell( const tripoint_abs_ms &p, Creature *critter, item * );
bool lua( const tripoint_abs_ms &p, Creature *target, item *trap );
} // namespace trapfunc
...
using trap_function = std::function<bool( const tripoint_abs_ms &, Creature *, item * )>;
...
struct trap {
    ...
    public:
        ...
        bool detect_trap( const tripoint_abs_ms &pos, const Character &p ) const;
        /**
         ...
         */
        void trigger( const tripoint_abs_ms &pos, Creature *creature = nullptr,
         ...
         * @ref map::remove_trap.
         */
        void trigger_aftermath( mapbuffer &m, const tripoint_abs_ms &p ) const;
        /**
         ...
         * @ref map::remove_trap.
         */
        void on_disarmed( mapbuffer &m, const tripoint_abs_ms &p ) const;
        /**
