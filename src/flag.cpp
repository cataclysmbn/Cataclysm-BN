...
const flag_id flag_EFFECT_MODIFIES_OUTGOING_SOUND( "EFFECT_MODIFIES_OUTGOING_SOUND" );
const flag_id flag_EFFECT_MODIFIES_INCOMING_SOUND( "EFFECT_MODIFIES_INCOMING_SOUND" );
const flag_id flag_EFFECT_CREATES_SOUNDS( "EFFECT_CREATES_SOUNDS" );
