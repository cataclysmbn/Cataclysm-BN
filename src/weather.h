...
const weather_type_id &current_weather( const tripoint_bub_ms &location,
...
class weather_manager
{
    public:
        ...
        auto get_temperature( const tripoint_bub_ms &location ) const -> units::temperature;
        ...
        auto get_water_temperature( const tripoint_bub_ms &location ) const -> units::temperature;
