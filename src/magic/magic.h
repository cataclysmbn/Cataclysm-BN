...
class spell
{
    ...
    public:
        ...
        std::optional<tripoint_abs_ms> random_valid_target( const Creature &caster,
                const tripoint_abs_ms &caster_pos ) const;
...
std::set<tripoint_abs_ms> spell_effect_blast( const spell &, const tripoint_abs_ms &,
        const tripoint_abs_ms &target,
        int aoe_radius, bool ignore_walls );
std::set<tripoint_abs_ms> spell_effect_cone( const spell &sp, const tripoint_abs_ms &source,
        const tripoint_abs_ms &target,
        int aoe_radius, bool ignore_walls );
std::set<tripoint_abs_ms> spell_effect_line( const spell &, const tripoint_abs_ms &source,
        const tripoint_abs_ms &target,
        int aoe_radius, bool ignore_walls );
