...
Each `.yarn` file becomes one *story*. The story name equals the filename without the `.yarn`
...
All legacy talk tags are also expanded in dialogue text and choice labels. These are unchanged
...
does not require the legacy key naming convention.
