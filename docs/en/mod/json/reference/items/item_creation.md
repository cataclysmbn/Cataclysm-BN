...
"loudness": 145,            // Base ammunition loudness, measured in dB spl. Guns tend to float aroun 145-165dB. Default/Minimum of -1 to use the auto calculated value, maximum of 191dB spl.
"speed": 200,               // Speed of the ammo in meters per second. Speed of sound is taken at 343 m/s, default value is 1000. If ammunition is faster than the speed of sound and does not have a volume of 0, it will make a small sonic boom. 
