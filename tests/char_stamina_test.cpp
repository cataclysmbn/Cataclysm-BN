...
static auto actual_burn_rate(player& dummy, character_movemode move_mode) -> int {
...
static auto burdened_burn_rate(
    player& dummy, character_movemode move_mode, float burden_proportion = 0.0) -> int {
...
static auto actual_regen_rate(player& dummy, int moves) -> float {
