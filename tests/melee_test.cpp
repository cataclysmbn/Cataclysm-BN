...
TEST_CASE("manual technique queries include counter techniques", "[melee]") {
    ...
    CHECK(std::ranges::find(normal_attack_techniques, counter) == normal_attack_techniques.end());
    CHECK(std::ranges::find(normal_attack_techniques, defensive) == normal_attack_techniques.end());
    ...
    CHECK(std::ranges::find(manual_attack_techniques, counter) != manual_attack_techniques.end());
    CHECK(std::ranges::find(manual_attack_techniques, defensive) != manual_attack_techniques.end());
