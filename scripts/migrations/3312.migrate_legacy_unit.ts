...
const getDistanceForVolumeLoss = (tileDistance: number) => {
  if (tileDistance < minimumDistanceForSoundPropagation) {
    return minimumDistanceForSoundPropagation
  }
  if (tileDistance > maximumDistanceForSoundPropagation) {
    return maximumDistanceForSoundPropagation
  }
