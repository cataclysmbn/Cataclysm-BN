...
---@field add_known_trap fun(self: Character, arg2: Tripoint, arg3: TrapIntId)
---@field add_known_trap fun(self: Character, arg2: Tripoint, arg3: TrapRaw) @Character learns that the given trap is on the given tripoint. If the trap is null, the character learns that there is no trap there.
...
---@field knows_trap fun(self: Character, arg2: Tripoint): boolean @Whether the character knows about the trap at the given tripoint.
