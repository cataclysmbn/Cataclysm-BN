...
---@field on_character_effect_removed fun(params: table) @Called when character loses the effect which has `EFFECT_LUA_ON_REMOVED` flag.  <br />The hook receives a table with keys:  <br />* `char` (Character)  <br />* `effect` (Effect)  
